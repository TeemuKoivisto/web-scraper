module.exports = {
  ...
  MONGO_URI: process.env.MONGO_URI || 'mongodb://omistaja:asdf@ds045704.mongolab.com:45704/nh-test',

  // OAuth 2.0
  FACEBOOK_SECRET: process.env.FACEBOOK_SECRET || 'eaf4c261670eccb309b9bd18f850973e',
  FOURSQUARE_SECRET: process.env.FOURSQUARE_SECRET || '',
  GOOGLE_SECRET: process.env.GOOGLE_SECRET || 'AnOguv4kLM_wNWKA2ZRvN1ZD',
